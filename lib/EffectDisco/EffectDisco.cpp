...
//                                   period 5      width 2
//
static void drawRainbowDashes(struct CRGB *leds, int ledsToUse, uint8_t startpos, uint16_t lastpos, uint8_t period, uint8_t width, uint8_t huestart, uint8_t huedelta, uint8_t saturation, uint8_t value)
{
...
//
void discoWorker(struct CRGB *leds, int ledsToUse, uint8_t dashperiod, uint8_t dashwidth, int8_t dashmotionspeed, uint8_t stroberepeats, uint8_t huedelta)
{
    ...
    drawRainbowDashes(leds, ledsToUse, sStartPosition, ledsToUse - 1,
...
void handleDisco(struct CRGB *leds, int numToFill)
{
    ...
    if (sStrobePhase == 0)
    {
        ...
        discoWorker(leds, numToFill, dashperiod, dashwidth, dashmotionspeed, strobesPerPosition, hueShift);
